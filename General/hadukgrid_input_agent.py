...
def read_nc(var_name,loc=True):
    ...
    '''
    fn = 'C:/Users/Bro Soup/Desktop/University of Cambridge/Mphil in ChemE&Biotech/Heat_pump_code/Temporary/Code/haduk_files/'+var_name+'_hadukgrid_uk_1km_mon_202001-202012.nc'
    ds = nc.Dataset(fn)
...
def LSOA_polygon_query(limit):
    ...
    usage_vals = res_array[1:,:]
     ...
     '''
    usage_vals = call_pickle(shapes_filename)
...
for i in tqdm(range(int(len(LSOA)))):
    ...
    for month_it in range(len(months)):
        ...
        endUTC = '2020-'+month_str+'-'+str(month_end)+'T12:00:00'
